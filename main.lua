      ...
      for _, p in pairs(game.Players:GetPlayers()) do
          if p ~= game.Players.LocalPlayer and p.Character then
              if Value then
                  ...
                  High.Name = "ForsakenESP"
                  High.FillColor = Color3.fromRGB(0, 255, 0)
              else
                  if p.Character:FindFirstChild("ForsakenESP") then p.Character.ForsakenESP:Destroy() end
              end
          end
      end
   end,
...
Rayfield:Notify({Title = "V1 READY", Content = "Jump, Speed, and ESP modules are synchronized.", Duration = 5})
